...
//        self.dateLabel.dk_textColorPicker = kTextColorPicker;
//        self.dateTitleLabel.dk_textColorPicker = kTextColorPicker;
        self.dateTitleLabel.textColor = selectedThemeIndex==0?kDefaultColor:[UIColor whiteColor];
        self.dateLabel.textColor = selectedThemeIndex==0?kDefaultColor:[UIColor whiteColor];
    }
}
