...
//        [button addTarget:self action:@selector(tap:) forControlEvents:UIControlEventTouchUpInside];
        ...
        if ([[self.values objectAtIndex:i] intValue]>self.maxValue) {
            ...
            if (self.type == SensorDataHeart) {
                ...
                [buttonImage setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@"btn_fatal_exception_1"]] forState:UIControlStateNormal];
            }
            ...
            if (self.type == SensorDataHeart) {
                ...
                [buttonImage setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@"btn_abnormal_1"]] forState:UIControlStateNormal];
            }
