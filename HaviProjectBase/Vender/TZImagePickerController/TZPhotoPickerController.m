...
- (void)configBottomToolBar {
    ...
    CGFloat previewWidth = [previewText boundingRectWithSize:CGSizeMake(CGFLOAT_MAX, CGFLOAT_MAX) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:kDefaultWordFont} context:nil].size.width;
    ...
    _previewButton.titleLabel.font = kDefaultWordFont;
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        _originalPhotoButton.titleLabel.font = kDefaultWordFont;
        ...
        _originalPhotoLable.font = kDefaultWordFont;
    ...
    _okButton.titleLabel.font = kDefaultWordFont;
