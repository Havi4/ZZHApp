...
//    self.collectionView.bounces = NO;//将网格视图的下拉效果关闭
    ...
    self.collectionView.dk_backgroundColorPicker = DKColorWithColors([UIColor colorWithRed:0.008 green:0.114 blue:0.227 alpha:1.00], [UIColor colorWithRed:0.322 green:0.592 blue:0.761 alpha:1.00]);
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (kind == UICollectionElementKindSectionHeader){
        ...
        monthHeader.dk_backgroundColorPicker = DKColorWithColors([UIColor colorWithRed:0.008 green:0.114 blue:0.227 alpha:1.00], [UIColor colorWithRed:0.322 green:0.592 blue:0.761 alpha:1.00]);
