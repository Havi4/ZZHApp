...
- (void)setup
{
    ...
    self.masterLabel.dk_textColorPicker = DKColorWithColors(COLOR_THEME, [UIColor whiteColor]);;
    ...
    self.day1OfTheWeekLabel.dk_textColorPicker = DKColorWithColors(COLOR_THEME1, [UIColor whiteColor]);;
    ...
    self.day2OfTheWeekLabel.dk_textColorPicker = DKColorWithColors(COLOR_THEME, [UIColor whiteColor]);;
    ...
    self.day3OfTheWeekLabel.dk_textColorPicker = DKColorWithColors(COLOR_THEME, [UIColor whiteColor]);
    ...
    self.day4OfTheWeekLabel.dk_textColorPicker = DKColorWithColors(COLOR_THEME, [UIColor whiteColor]);
    ...
    self.day5OfTheWeekLabel.dk_textColorPicker = DKColorWithColors(COLOR_THEME, [UIColor whiteColor]);
    ...
    self.day6OfTheWeekLabel.dk_textColorPicker = DKColorWithColors(COLOR_THEME, [UIColor whiteColor]);
    ...
    self.day7OfTheWeekLabel.dk_textColorPicker = DKColorWithColors(COLOR_THEME1, [UIColor whiteColor]);
