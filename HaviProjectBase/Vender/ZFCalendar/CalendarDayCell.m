...
- (void)initView{
    ...
    day_title.dk_textColorPicker = DKColorWithColors([UIColor whiteColor], [UIColor whiteColor]);
...
- (void)setModel:(CalendarDayModel *)model
{
    ...
    switch (model.style) {
        ...
        case CellDayTypePast://过去的日期
            ...
            day_lab.dk_textColorPicker = DKColorWithColors([UIColor lightGrayColor], [UIColor lightGrayColor]);
        ...
        case CellDayTypeFutur://将来的日期
            ...
            if (model.holiday) {
                ...
                day_lab.text = [NSString stringWithFormat:@"%lu",(unsigned long)model.day];
                day_lab.dk_textColorPicker = DKColorWithColors(COLOR_THEME, [UIColor colorWithRed:0.439 green:0.890 blue:0.357 alpha:1.00]);
            }
