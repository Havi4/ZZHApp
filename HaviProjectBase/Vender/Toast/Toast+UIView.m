...
- (void)makeToastActivity {
    [self makeToastActivity:CSToastActivityDefaultPosition andName:@"登录中..."];
}

- (void)makeToastActivity:(id)position andName:(NSString *)string {
    // sanity
    ...
    activityIndicatorView.center = CGPointMake(activityView.bounds.size.width / 2, activityView.bounds.size.height / 3);
