...
- (void)configureViews {
    ...
    [self.monthButton setImage:[[UIImage imageNamed:@"month_1"] imageWithTintColor:kColorBlueDefault] forState:UIControlStateSelected];
    ...
    [self.quaterButton setImage:[[UIImage imageNamed:@"quarter_1"] imageWithTintColor:[UIColor blackColor]] forState:UIControlStateNormal];
    [self.quaterButton setImage:[[UIImage imageNamed:@"quarter_1"] imageWithTintColor:kColorBlueDefault] forState:UIControlStateSelected];
