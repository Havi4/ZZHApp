...
{
    NSString *tockenUrl = [NSString stringWithFormat:@"%@v1/app/GetWeather?City=%@&Province=%@",[NSObject baseURLStrIsTest] ? kAppTestBaseURL: kAppBaseURL,[parameters objectForKey:@"city"],[parameters objectForKey:@"province"]];
