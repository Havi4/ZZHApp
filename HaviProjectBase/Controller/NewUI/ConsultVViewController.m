...
#pragma mark - 四类个性化设置，这些参数都可以不传，此时会走默认设置
    ...
    imagePickerVc.allowPickingOriginalPhoto = NO;
    [imagePickerVc.navigationBar setBarTintColor:[UIColor colorWithRed:0.176 green:0.173 blue:0.196 alpha:1.00]];
...
- (void)uploadProblem
{
    ...
    [NSObject hideHud];
    NSString *url = [NSString stringWithFormat:@"%@v1/cy/FreeProblem/Create",[NSObject baseURLStrIsTest] ? kAppTestBaseURL: kAppBaseURL];
