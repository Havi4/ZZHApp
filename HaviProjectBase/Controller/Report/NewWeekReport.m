...
- (void)drawFuncLine
{
    ...
    for (int i=0; i<_sleepQulityDataValues.count; i++) {
        ...
        __block SleepQualityBar *bar = [[SleepQualityBar alloc] initWithFrame:CGRectMake(xPoint.x+6, 15+(yCoordinateHeight-15)-height-5, 5,height) andGrade:(int)gradePercent];
        bar.alpha = 0;
