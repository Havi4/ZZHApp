...
- (void)initSubView
{
    ...
    startTitleLabel.dk_textColorPicker = DKColorWithColors([UIColor colorWithRed:0.000f green:0.859f blue:0.573f alpha:1.00f], [UIColor whiteColor]);
    ...
    statrtDataLabel.dk_textColorPicker = DKColorWithColors([UIColor colorWithRed:0.000f green:0.859f blue:0.573f alpha:1.00f], [UIColor whiteColor]);
    statrtDataLabel.text = @"08:09";
