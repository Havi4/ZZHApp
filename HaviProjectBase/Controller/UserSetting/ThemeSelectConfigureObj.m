...
@implementation ThemeSelectConfigureObj

+ (ThemeSelectConfigureObj *)defaultConfigure
{
    static ThemeSelectConfigureObj *configureObj = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^
    {
        configureObj = [[ThemeSelectConfigureObj alloc] init];
    });
...
- (id)init
{
    ...
    _nThemeIndex = [[[NSUserDefaults standardUserDefaults] objectForKey:kTHEME_TAG] intValue];
